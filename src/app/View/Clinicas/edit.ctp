<h1 class="ls-title-intro ls-ico-pencil">Alteração de Clínica</h1>

<?php echo $this->Form->create('Clinica', array('action' => 'edit', 'class' => 'ls-form ls-form-horizontal row')); ?>
...
<?php
echo $this->Form->input('uf', array('div' => 'ls-custom-select', 'class' => 'ls-custom', 'label' => false, 'options' => array('AC' => 'Acre',
'AL' => 'Alagoas',
'AP' => 'Amapá',
'AM' => 'Amazonas',
'BA' => 'Bahia',
