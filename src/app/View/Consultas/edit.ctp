...
echo $this->Form->create('Consulta', array('action' => 'edit', 'class' => 'ls-form row', 'type' => 'file'));
...
echo $this->Form->input('paciente_id', array('div' => 'ls-label col-md-3', 'disabled' , 'options' => $pacientes));
